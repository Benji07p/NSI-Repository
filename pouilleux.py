...
class Joueur:
    ...
    def retirer_carte(self, num):
        ...
        return self.paquet.pop(num).carte_visible()
...
class Pouilleux:
    ...
    def distribuer(self):
        ...
        for i in range(4):
            ...
            cartes.append(Carte(i,13))
            cartes.append(Carte(i,14))
            if i != 3:
                cartes.append(Carte(i,11))
        shuffle(cartes)
        for j in range(17):
            for i in range(3):
    ...
    def retirer_paires(self):
        ...
        for i in range(3):
            while self.joueurs[i].trouver_paire() is not None:
                ...
                self.joueurs[i].retirer_carte(var[1])
    ...
    def retirer_paire_de(self, joueur):
        ...
        self.joueurs[joueur].retirer_carte(self.joueurs[joueur].trouver_paire()[0])
        self.joueurs[joueur].retirer_carte(self.joueurs[joueur].trouver_paire()[1])
    ...
    def obtenir_carte_de(self, joueur, num):
        ...
        est donné'''
        self.joueurs[joueur].obtenir_carte(num)
    ...
    def retirer_carte_a(self, joueur, num):
        ...
        self.joueurs[joueur].retirer_carte(num)
